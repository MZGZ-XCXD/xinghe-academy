 ...
 *    6. 改完建议先体检：在游戏目录执行
 *         npm run check:content "C:\Users\59514\Desktop\校园内容.js"
 *       它会告诉你语法有没有错、有没有误用中文全角标点、以及一共生效了几条。
 *       原因：整份文件是一段 JS 脚本，**只要一个标点写错，整个文件都不会被读取**，
 *       游戏里表现为「自定义内容：未加载 / 0 项」。引号里的中文标点没问题，
 *       引号外面的逗号 / 冒号 / 括号必须是半角 ，不要写成 ，：；（）
 *
 *  注意：
